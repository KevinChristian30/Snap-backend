...
@Component
@AllArgsConstructor
public class EmailAndPasswordAuthProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!passwordEncoder.matches(password, userDetails.getPassword())) {
            throw new BadCredentialsException(Constants.ErrorMessage.Authentication.BAD_CREDENTIALS);
        }
